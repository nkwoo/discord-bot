...
export class TranslationImpl implements Translation {
    ...
    async translationLang(channel: TextChannel | DMChannel | GroupDMChannel, content: string, target: string) {
        const editMsg = await channel.send("데이터 조회중......");
    ...
    getTranslationCode(channel: TextChannel | DMChannel | GroupDMChannel) {
